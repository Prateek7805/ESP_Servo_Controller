...
<svg xmlns=http://www.w3.org/2000/svg id=ID_DARK_IMG class=theme-svg viewBox="0 0 24 24" fill=none stroke-width=2 stroke-linecap=round stroke-linejoin=round class="feather feather-moon">
